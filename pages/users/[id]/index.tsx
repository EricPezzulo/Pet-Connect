              ...
              <div className="flex flex-col justify-center">
                {user.status ? (
                  <div className="flex items-center">
                    <div className="w-7 text-purple-600 pr-1">
                      <ChatQuoteFill />
                    </div>
                    <p className="text-xl font-light">{user.status}</p>
                  </div>
                ) : null}
                {user.location ? (
                  <div className="flex items-center">
                    <div className="w-7 text-purple-600">
                      <LocationPin />
                    </div>
                    <p className="text-xl font-light">{user.location}</p>
                  </div>
                ) : (
                ...
                {user.publicEmail ? (
                  <div className="flex items-center">
                    ...
                    <p className="text-xl font-light">{user.publicEmail}</p>
                  </div>
                ) : (
                ...
                {session &&
                  (openEditProfileModule ? (
                    <div className="my-2">
                      <button
                        className="bg-purple-600 text-white px-2 py-1 rounded-lg w-16"
                        onClick={() =>
                          setOpenEditProfileModule(
                            (openEditProfileModule) => !openEditProfileModule
                          )
                        }
                      >
                        Close
                    ...
                    <div className="my-2">
                      <button
                        className="bg-purple-600 px-2 text-white py-1 rounded-lg w-16"
                        type="submit"
                        onClick={() =>
                          setOpenEditProfileModule(
                            (openEditProfileModule) => !openEditProfileModule
